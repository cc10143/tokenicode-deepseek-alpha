...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // InputBar
    'input.working': '模型正在工作...',
    'input.followUp': '追加消息...',
    'input.placeholder': '给当前模型发消息...',
    ...
    'preview.openInAppWindow': '应用内打开',
    'preview.openedInAppWindow': '已在独立的应用内浏览窗口打开',
    'preview.openedExternal': '应用内窗口不可用，已改用系统浏览器',
    'preview.remotePageTitle': '此网站不允许嵌入侧栏',
    'preview.remotePageHint': '应用会用独立的内置浏览窗口打开，避免网站的 iframe 访问限制。',
    ...
    'chat.thinkingCycle.1': '读取上下文',
    'chat.thinkingCycle.2': '规划步骤',
    'chat.thinkingCycle.3': '执行任务',
    'chat.thinkingCycle.4': '整理回复',
    ...
    'msg.questionPreview': '预览',
    'msg.planReview': '审查模型的计划',
    'msg.planApprove': '批准计划并开始执行',
    'msg.planModify': '告诉模型如何修改',
    ...
    'provider.opusModel': 'Opus 档实际模型',
    'provider.sonnetModel': 'Sonnet 档实际模型',
    'provider.haikuModel': 'Haiku 档实际模型',
    ...
    'cmd.helpSkills': '技能',
    'cmd.hotkeyTitle': '键盘快捷键',
    'cmd.hotkeyPanel': '面板与窗口',
    'cmd.hotkeyTask': '任务控制',
    'cmd.hotkeyInput': '输入框',
    'cmd.hotkeyToggleTaskPanel': '任务面板开关',
    'cmd.hotkeyCommandPalette': '命令面板开关',
    'cmd.hotkeyRecentSession': '最近两个会话快速切换',
    'cmd.hotkeyZoom': '界面缩放',
    'cmd.hotkeyZoomWheel': '界面缩放（滚轮）',
    'cmd.hotkeyStopAllTasks': '停止全部运行中任务',
    'cmd.hotkeySendOrNewline': '发送 / 换行（可在设置切换）',
    'cmd.hotkeySendAlt': '发送（备选）',
    'cmd.hotkeyClearPrefix': '清空当前前缀',
    'cmd.hotkeyCloseOverlay': '关闭命令面板',
    'cmd.hotkeyInterrupt': '打断当前生成',
    ...
    'skills.title': '技能',
    'skills.refresh': '刷新',
    'skills.addDirectory': '添加技能目录',
    'skills.removeDirectory': '移除技能目录',
    'skills.create': '创建',
    'skills.cancel': '取消',
    'skills.edit': '编辑',
    'skills.save': '保存',
    ...
    'skills.delete': '删除',
    'skills.loading': '加载中...',
    'skills.readFailed': '无法读取所选技能，请检查技能目录和 SKILL.md 文件。',
  ...
  en: {
    ...
    // InputBar
    'input.working': 'The model is working...',
    'input.followUp': 'Send follow-up...',
    'input.placeholder': 'Message the selected model...',
    ...
    'preview.openInAppWindow': 'Open in app',
    'preview.openedInAppWindow': 'Opened in a separate in-app browser window',
    'preview.openedExternal': 'In-app window unavailable; opened in the system browser',
    'preview.remotePageTitle': 'This site does not allow sidebar embedding',
    'preview.remotePageHint': 'Open it in a separate in-app browser window to avoid iframe restrictions.',
    ...
    'chat.thinkingCycle.1': 'Reading context',
    'chat.thinkingCycle.2': 'Planning steps',
    'chat.thinkingCycle.3': 'Running task',
    'chat.thinkingCycle.4': 'Preparing reply',
    ...
    'msg.questionPreview': 'Preview',
    'msg.planReview': 'Review the model\'s plan',
    'msg.planApprove': 'Approve plan and start coding',
    'msg.planModify': 'Tell the model what to change',
    ...
    'provider.opusModel': 'Actual Opus-tier model',
    'provider.sonnetModel': 'Actual Sonnet-tier model',
    'provider.haikuModel': 'Actual Haiku-tier model',
    ...
    'slash.desc.hotkey': 'Show keyboard shortcuts',
    ...
    'cmd.hotkeyTitle': 'Keyboard Shortcuts',
    'cmd.hotkeyPanel': 'Panels & Window',
    'cmd.hotkeyTask': 'Task Control',
    'cmd.hotkeyInput': 'Input',
    'cmd.hotkeyToggleTaskPanel': 'Toggle task panel',
    'cmd.hotkeyCommandPalette': 'Toggle command palette',
    'cmd.hotkeyRecentSession': 'Switch between two recent sessions',
    'cmd.hotkeyZoom': 'Zoom interface',
    'cmd.hotkeyZoomWheel': 'Zoom interface (wheel)',
    'cmd.hotkeyStopAllTasks': 'Stop all running tasks',
    'cmd.hotkeySendOrNewline': 'Send / new line (toggle in settings)',
    'cmd.hotkeySendAlt': 'Send (alternate)',
    'cmd.hotkeyClearPrefix': 'Clear active prefix',
    'cmd.hotkeyCloseOverlay': 'Close command palette',
    'cmd.hotkeyInterrupt': 'Interrupt current generation',
    ...
    'skills.addDirectory': 'Add skill directory',
    'skills.removeDirectory': 'Remove skill directory',
    ...
    'skills.readFailed': 'Could not read the selected skill. Check its directory and SKILL.md file.',
